...
interface Props { data: CoverSheetData | null; onGenerate: () => void; onNext: () => void; loading: boolean }
export function Step3CoverSheet({ data, onGenerate, onNext, loading }: Props) {
  return (
    <div>
